...
You need to upgrade your Kubernetes cluster from version 1.30.0 to version 1.30.4. Ensure that the control plane components are upgraded first, followed by the worker nodes.

Task:

Upgrade the Kubernetes control plane to version 1.30.4.
Upgrade the worker nodes to version 1.30.4 while minimizing downtime.
